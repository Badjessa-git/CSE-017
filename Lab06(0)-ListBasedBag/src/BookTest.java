...
public class BookTest extends TestCase {
    ...
    public void testBook() {
        assertEquals("Data Structures: Abstraction and Design Using Java", book.getTitle());
        assertEquals("Elliot B. Koffman and Paul A. T. Wolfgang", book.getAuthor());
    ...
    public void testToString() {
        assertEquals("Data Structures: Abstraction and Design Using Java, "
                + "Elliot B. Koffman and Paul A. T. Wolfgang, " + "978-0-470-12870-1", book.toString());
    }

    /**
     * Test method for {@link Book#equals(Object)}
     */
    public void testEquals() {
        assertFalse(book.equals(null));
        assertFalse(book.equals("Hello"));
        Book book1 = new Book("Data Structures: Abstraction and Design Using Java",
                "Elliot B. Koffman and Paul A. T. Wolfgang", "978-0-470-12870-1");
        Book book2 = new Book("Blah Blahd Blah", "Elliot B. Koffman and Paul A. T. Wolfgang", "978-0-470-12870-1");
        Book book3 = new Book("Data Structures: Abstraction and Design Using Java", "Something else",
                "978-0-470-12870-1");
        Book book4 = new Book("Data Structures: Abstraction and Design Using Java",
                "Elliot B. Koffman and Paul A. T. Wolfgang", "978-0-47");
